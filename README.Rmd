...
* [Chronos2 foundational model for forecasting](https://brulee.tidymodels.org/reference/brulee_chronos.html)

Chronos2 is the only model that uses a pretrained model, requiring a one-time download of about 500MB. 
