...
* Transformer-based foundation model [TabICL](https://brulee.tidymodels.org/reference/brulee_tab_icl.html)

Chronos2 and TabICL are pretrained models, requiring a one-time download of about 500MB and 225MB, respectively. 
