...
#' converted to probabilities with a temperature softmax. For regression, each
#' member contributes a full predictive distribution and the combination rule
#' depends on which statistic is requested; see [predict.brulee_tab_icl()].
